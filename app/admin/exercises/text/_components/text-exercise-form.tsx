...
interface Props {
  ...
  defaultContent?: TextAnswerExercise;
}

const initialState: ActionState = { status: "idle" };

export function TextExerciseForm({
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Input id="title" name="title" required defaultValue={defaultTitle} placeholder="לדוגמה: ניתוח גרף בכתיבה" />
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="הסבר לתלמיד מה עליו לכתוב..."
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <option value="auto_complete">מושלם אוטומטית עם השליחה</option>
        </select>
        <p className="text-xs text-muted-foreground">
          בדיקה ידנית: התלמיד מסמן &quot;ממתין לבדיקה&quot; עד שהמנהל מאשר. אוטומטי: התרגיל מושלם מיד עם השליחה.
        </p>
      </div>
