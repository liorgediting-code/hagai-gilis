...
import { MenuIcon, XIcon, LayoutDashboardIcon, UsersIcon, FolderIcon, FileTextIcon, DumbbellIcon, TrendingUpIcon, SettingsIcon } from "lucide-react";
...
const navLinks = [
  ...
  { href: "/admin/settings", label: "הגדרות", icon: SettingsIcon, exact: false },
];
