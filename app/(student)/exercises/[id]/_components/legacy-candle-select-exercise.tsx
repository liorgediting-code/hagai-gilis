...
interface LegacyCandleSelectExerciseProps {
  exerciseId: string;
  chartData: CandleChartExercise;
  hasSubmitted: boolean;
}

export function LegacyCandleSelectExercise({
  exerciseId,
  chartData,
  hasSubmitted,
}: LegacyCandleSelectExerciseProps) {
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      ...
      if (result.status === "success") {
        ...
        setError(result.error ?? "שגיאה בשמירת התשובה — נסה שנית");
      } else {
